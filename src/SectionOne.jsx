...
function SectionOne() {
    ...
    return (
        <div className="flex ml-30 mr-30 mt-10 gap-6 mb-10">
            ...
            <div id="center" className="">
                <img src={unshakable} alt="what_gospel" className="w-156 mb-4" />
                <div className="flex justify-center">
                    <span className="font-semibold text-[0.7rem] tracking-widest">FEATURED POST</span>
                    <span></span>
                </div>
            </div>
