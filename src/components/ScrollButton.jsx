...
export default function ScrollToTopButton() {
    ...
    return (
        <button type="button" onClick={backToTop}
            className={`
                cursor-pointer fixed bottom-10 right-10 p-3 bg-[#9c3466] hover:bg-gray-500 text-white rounded-full shadow-md transform transition-all duration-500 ease-out
