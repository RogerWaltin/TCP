        ...
        <div className="flex mx-32">
            ...
            <div id="latest" className="ml-5 w-169.5 border-x border-gray-300 wrap-break-word min-w-0">
                <div className="mx-5 w-159.2 flex flex-col min-w-0 wrap-break-word border-t-[0.15rem] border-t-[#a84d79]">
                    <span className="flex cursor-pointer hover:text-[#a84d79] transition duration-300 gap-3.5 mt-2.75 w-fit"><p className="font-semibold text-lg ">LATEST </p><FaArrowRight className="mt-1.75" /></span>

                    <div className="border-t border-gray-300 mt-[14.7px] flex gap-5">
                        <span className="cursor-pointer mt-3.25 w-57.5 h-37.5">
                        ...
                        <div className="flex flex-col justify-center">
                            <span className={`text-[1.4rem] font-serif mt-4.25 cursor-pointer ${underlineEffect} h-fit`}>
                    ...
                    <div className="border-t border-gray-300 mt-[14.7px] flex gap-5">
                        <span className="cursor-pointer mt-3.25 w-57.5 h-37.5 shrink-0">
