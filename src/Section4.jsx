    ...
    return (
        <div className="mx-32 mt-17">
            <section>
                ...
                <div className="py-3">
                    <span className="flex flex-row items-center gap-3.5 w-fit hover:cursor-pointer hover:text-[#a84d79] transition duration-300"><p className="text-lg font-semibold tracking-wider">VIDEOS</p> <FaArrowRight className="mt-0.5" /></span>
                </div>
            </section>
            ...
            <section className="flex gap-5 mb-22.5">
                <div className="border-r pr-5 border-gray-300 wrap-break-word">
                    <div className="w-237.5 h-125.5 shrink-0 relative hover:cursor-pointer">
                        ...
                        <div className="absolute bottom-5 left-5 text-white">
                            <p className="mb-2.5 uppercase text-white text-xs font-semibold tracking-wider whitespace-break-spaces"><span className="hover:cursor-pointer hover:opacity-70 transition duration-300">Documentary</span> <span className="hover:cursor-pointer hover:opacity-70 transition duration-300">Video</span></p>
                            <p className="group">
                ...
                <div>
                    <div className="w-72.5 h-41.5 shrink-0 relative hover:cursor-pointer">
                    ...
                    <p className="text-2xl font-serif leading-6 my-3 hover:cursor-pointer border-b border-gray-300 pb-5.5 group"><span className={`${underlineEffect1}`}>Are Husbands and Wives</span> <span className={`${underlineEffect2}`}>Equal?</span></p>
                    <div className="w-72.5 h-41.5 shrink-0 pt-1 relative hover:cursor-pointer">
                        <img className="w-full h-full object-cover" src="https://thecrosspurpose.com/wp-content/uploads/2023/08/what_we_do_and_why_box.jpg" alt="" />
                        <div className="absolute bottom-4 right-4 text-white">
                            <FaRegPlayCircle size={36} className="transition-transform duration-300 ease-in-out transform hover:scale-90" />
                        </div>
                    </div>
                    <p className="text-2xl font-serif leading-6 my-3 hover:cursor-pointer group"><span className={`${underlineEffect1}`}>Hope for the Prodigal</span></p>
                </div>
            </section>
        </div>
    )
